...
% FORWARD PROPOGATION
y_matrix = eye(num_labels)(y,:); %10*5000
...
a3=sigmoid(z3); %h_theta=a3 %10*5000
%size(a3);
%si=size(y_matrix,1);
%p=zeros(si,si);
...
for t=1:m
    ...
    a_2 = [1 ; a_2]; % adding a bias (26*1)
	z_3 = Theta2 * a_2; % (10*26)*(26*1)
	a_3 = sigmoid(z_3); % a3 = h_theta (10*1)
    
    % Step 2
    yVector = (1:num_labels)'==y(t); %10*1
    
	delta_3 = a_3 - yVector; % 10*1
	z_2=[1; z_2]; % bias (26*1)
    
    % Step 3
    delta_2 = (Theta2' * delta_3) .* sigmoidGradient(z_2); % (26*10)*(10*1)
